...
"}")
        ...
        self.page_history_quizz_container_bot_2 = QWidget(self.groupBox_4)
        self.page_history_quizz_container_bot_2.setObjectName(u"page_history_quizz_container_bot_2")
        self.page_history_quizz_container_bot_2.setGeometry(QRect(190, 30, 450, 241))
        ...
        sizePolicy4.setHeightForWidth(self.radioButton1_Quiz.sizePolicy().hasHeightForWidth())
        self.radioButton1_Quiz.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.radioButton2_Quiz.sizePolicy().hasHeightForWidth())
        self.radioButton2_Quiz.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.radioButton3_Quiz.sizePolicy().hasHeightForWidth())
        self.radioButton3_Quiz.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.radioButton4_Quiz.sizePolicy().hasHeightForWidth())
        self.radioButton4_Quiz.setSizePolicy(sizePolicy4)
