...
"}\n"
"\n"
"#quizzListPage #backButton, #chooseNbToDisplayPage #backButton_2, #chooseOrderPage #backButton_3, #createQuestionsPage #backButton_4, #nameQuizzPage #backButton_5, #history #backButton_6 {\n"
"	background-color: transparent ;\n"
"}\n"
"\n"
"#pagesList > QWidget{\n"
...
"}")
        ...
        self.backButton_5 = QPushButton(self.nameQuizzPage)
        self.backButton_5.setObjectName(u"backButton_5")
        self.backButton_5.setGeometry(QRect(90, 90, 75, 24))
        icon4 = QIcon()
        icon4.addFile(u":/icons/images/back.png", QSize(), QIcon.Normal, QIcon.Off)
        self.backButton_5.setIcon(icon4)
        self.backButton_5.setAutoDefault(False)
        ...
        self.backButton_4 = QPushButton(self.createQuestionsPage)
        self.backButton_4.setObjectName(u"backButton_4")
        self.backButton_4.setGeometry(QRect(50, 80, 75, 24))
        self.backButton_4.setIcon(icon4)
        self.backButton_4.setAutoDefault(False)
        ...
        self.backButton_3 = QPushButton(self.chooseOrderPage)
        self.backButton_3.setObjectName(u"backButton_3")
        self.backButton_3.setGeometry(QRect(50, 80, 75, 24))
        self.backButton_3.setIcon(icon4)
        self.backButton_3.setAutoDefault(False)
        ...
        self.backButton_2 = QPushButton(self.chooseNbToDisplayPage)
        self.backButton_2.setObjectName(u"backButton_2")
        self.backButton_2.setGeometry(QRect(50, 80, 75, 24))
        self.backButton_2.setIcon(icon4)
        ...
        self.backButton = QPushButton(self.quizzListPage)
        self.backButton.setObjectName(u"backButton")
        self.backButton.setGeometry(QRect(50, 80, 75, 24))
        ...
        self.backButton_6 = QPushButton(self.history)
        self.backButton_6.setObjectName(u"backButton_6")
        self.backButton_6.setGeometry(QRect(50, 87, 121, 24))
        self.backButton_6.setIcon(icon4)
        self.backButton_6.setAutoDefault(False)
        self.groupBox_4 = QGroupBox(self.history)
        self.groupBox_4.setObjectName(u"groupBox_4")
        self.groupBox_4.setGeometry(QRect(0, 180, 841, 421))
        self.groupBox_4.setAlignment(Qt.AlignCenter)
        self.page_history_quizz_container_bot = QWidget(self.groupBox_4)
        self.page_history_quizz_container_bot.setObjectName(u"page_history_quizz_container_bot")
        self.page_history_quizz_container_bot.setGeometry(QRect(190, 30, 450, 241))
        self.label_9 = QLabel(self.history)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(0, 90, 841, 91))
        ...
        self.pagesList.setCurrentIndex(4)
        self.backButton_5.setDefault(False)
        self.backButton_4.setDefault(False)
        self.backButton_3.setDefault(False)
        self.backButton_2.setDefault(False)
        self.backButton.setDefault(False)
        self.backButton_6.setDefault(False)
    ...
    def retranslateUi(self, userMenu):
        ...
        self.backButton_6.setText(QCoreApplication.translate("userMenu", u"Retour acceuil", None))
        self.groupBox_4.setTitle("")
        self.label_9.setText(QCoreApplication.translate("userMenu", u"<html><head/><body><p><span style=\" font-size:30pt;\">Historique</span></p></body></html>", None))
    # retranslateUi
