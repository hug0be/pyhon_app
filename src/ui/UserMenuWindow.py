...
"}")
        ...
        self.quizzPages = QWidget()
        self.quizzPages.setObjectName(u"quizzPages")
        self.questions = QStackedWidget(self.quizzPages)
        ...
        self.answerQuestion1.setChecked(False)

        self.answers_6.addWidget(self.answerQuestion1)
        ...
        self.answers_6.addWidget(self.answerQuestion2)
        ...
        self.answers_6.addWidget(self.answerQuestion3)
        ...
        self.answers_6.addWidget(self.answerQuestion4)

        self.label_4 = QLabel(self.questionPage)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(190, 190, 101, 16))
        self.label_6 = QLabel(self.questionPage)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(690, 120, 61, 20))
        self.pointsLabel = QLabel(self.questionPage)
        self.pointsLabel.setObjectName(u"pointsLabel")
        self.pointsLabel.setGeometry(QRect(690, 70, 61, 51))
        ...
        self.nbQuestionLabel.setGeometry(QRect(690, 480, 61, 16))
        self.validateAnswerButton = QPushButton(self.questionPage)
        self.validateAnswerButton.setObjectName(u"validateAnswerButton")
        self.validateAnswerButton.setGeometry(QRect(290, 470, 251, 30))
        self.validateAnswerButton.setMinimumSize(QSize(0, 30))
        self.questionLabel = QLabel(self.questionPage)
        self.questionLabel.setObjectName(u"questionLabel")
        self.questionLabel.setGeometry(QRect(220, 110, 391, 51))
        self.titleLabel = QLabel(self.questionPage)
        self.titleLabel.setObjectName(u"titleLabel")
        self.titleLabel.setGeometry(QRect(0, 10, 841, 51))
        ...
        self.pagesList.addWidget(self.quizzPages)
    ...
    def retranslateUi(self, userMenu):
        ...
        self.answerQuestion1.setText(QCoreApplication.translate("userMenu", u"          R\u00e9ponse 1", None))
        self.answerQuestion2.setText(QCoreApplication.translate("userMenu", u"          R\u00e9ponse 2", None))
        self.answerQuestion3.setText(QCoreApplication.translate("userMenu", u"          R\u00e9ponse 3", None))
        self.answerQuestion4.setText(QCoreApplication.translate("userMenu", u"          R\u00e9ponse 4", None))
        self.label_4.setText(QCoreApplication.translate("userMenu", u"<html><head/><body><p><span style=\" font-weight:600;\">Votre r\u00e9ponse</span></p></body></html>", None))
        self.label_6.setText(QCoreApplication.translate("userMenu", u"Points", None))
        self.pointsLabel.setText(QCoreApplication.translate("userMenu", u"20", None))
        self.nbQuestionLabel.setText(QCoreApplication.translate("userMenu", u"23/30", None))
        self.validateAnswerButton.setText(QCoreApplication.translate("userMenu", u"Valider", None))
        self.questionLabel.setText(QCoreApplication.translate("userMenu", u"Question", None))
        self.titleLabel.setText(QCoreApplication.translate("userMenu", u"Nom du Quiz", None))
